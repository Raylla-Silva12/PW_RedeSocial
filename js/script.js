...
$(document).on('change','#uf',function(){
    var uf = $(this).val();
    $('#cidade').load('ajax.php?cidade_estado='+uf);
});

$(document).on('change','#uf2',function(){   
    var uf2 = $(this).val();
    $('#cidade2').load('ajax.php?cidade_estado='+uf2);
});

$(document).on('change','#escola',function(){
    var escola = $(this).val();
    console.log(escola);
    $('#curso').load('ajax.php?curso_escola='+escola);
});
$(document).on('change','#curso',function(){
    var curso = $(this).val();
    console.log(escola);
    $('#turma').load('ajax.php?turma_curso='+curso);
});
