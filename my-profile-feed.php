...
<body>
	...
	<div class="wrapper">
		...
		<header>
			<div class="container">
				<div class="header-data">
					<div class="logo">
						<a href="index.html" title=""><img src="images/logo3.png" alt=""></a>
					</div>
					<!--logo end-->
					<?php include('nav.inc'); ?>
				</div>
		...
		<section class="cover-sec">
			...
			<a href="#" title=""><i class="fa fa-camera"></i> Trocar Foto</a>
		</section>
								...
								<div class="main-left-sidebar">
									<div class="user_profile">
										...
										<div class="user_pro_status">
											<ul class="flw-hr">
												<li><a href="#" title="" class="flww"><i class="la la-edit"></i> Editar Perfil</a></li>
												<li><a href="#" title="" class="hre">??</a></li>
											</ul>
											<ul class="flw-status">
												<li>
													<span>Views</span>
										...
										<ul class="social_links">
											<li><a href="#" title=""><i class="la la-envelope"></i> email@servidor.com</a></li>
											<li><a href="#" title=""><i class="fa fa-phone"></i> 13 4587-4788</a></li>
											<li><a href="#" title=""><i class="fa fa-genderless"></i> Feminino</a></li>
											<li><a href="#" title=""><i class="fa fa-flag"></i> Itanhaém / SP</a></li>
											<li><a href="#" title=""><i class="fa fa-calendar"></i> 13/02/1989</a></li>
										</ul>
									</div>
									<!--user_profile end-->
								...
								<div class="main-ws-sec">
									<div class="user-tab-sec">
										...
										<div class="star-descp">
											<span>Programador, Design e DBA</span>
											<ul>
